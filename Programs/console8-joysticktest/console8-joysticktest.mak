...
#
# ZDS II Make File - console8-joysticktest project, Debug configuration
#
...
# project directory
PRJDIR = C:\source\Agon\Programs\console8-joysticktest
PRJDIR_ESCSPACE = C:\source\Agon\Programs\console8-joysticktest

# intermediate files directory
WORKDIR = C:\source\Agon\Programs\console8-joysticktest\Debug
WORKDIR_ESCSPACE = C:\source\Agon\Programs\console8-joysticktest\Debug

# output files directory
OUTDIR = C:\source\Agon\Programs\console8-joysticktest\Debug\
OUTDIR_ESCSPACE = C:\source\Agon\Programs\console8-joysticktest\Debug\
...
LDFLAGS = @..\console8-joysticktest.linkcmd
build: console8-joysticktest relist

buildall: clean console8-joysticktest relist

relink: deltarget console8-joysticktest

deltarget: 
	@if exist "$(WORKDIR)\console8-joysticktest.lod"  \
            $(RM) "$(WORKDIR)\console8-joysticktest.lod"
	@if exist "$(WORKDIR)\console8-joysticktest.hex"  \
            $(RM) "$(WORKDIR)\console8-joysticktest.hex"
	@if exist "$(WORKDIR)\console8-joysticktest.map"  \
            $(RM) "$(WORKDIR)\console8-joysticktest.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\Debug\vdp.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\Debug\agontimer.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\console8-joysticktest\Debug\console8-joysticktest.map" \
            C:\source\Agon\Programs\console8-joysticktest\agontimer-timer0.asm
