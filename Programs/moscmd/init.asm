...
_exec_name:		DB	"LOADER.BIN", 0					; The executable name, only used in argv
_load_name:		DB	"/MOS/LOADER.LDR", 0					; The loadable module name
_error_string:	DB	"Error loading file\r\n",0
