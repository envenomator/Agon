...
# project directory
PRJDIR = C:\source\Agon\test
PRJDIR_ESCSPACE = C:\source\Agon\test

# intermediate files directory
WORKDIR = C:\source\Agon\test\Debug
WORKDIR_ESCSPACE = C:\source\Agon\test\Debug

# output files directory
OUTDIR = C:\source\Agon\test\Debug\
OUTDIR_ESCSPACE = C:\source\Agon\test\Debug\
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\Debug\vdp.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\Debug\agontimer.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\test\Debug\test.map" \
            C:\source\Agon\test\agontimer-timer0.asm
